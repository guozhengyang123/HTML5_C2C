...
<div class="container clearfix">
 ...
 <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<?php echo U('Admin/index/index');?>">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">所有商务会议</span></div>
        </div>
        <div class="result-wrap">
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Admin/meet/create');?>"><i class="icon-font"></i>新增会议</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($meet)): $i = 0; $__LIST__ = $meet;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="<?php echo ($vo["subject"]); ?>"><a target="_blank" href="#" title="<?php echo ($vo["subject"]); ?>"><?php echo ($vo["subject"]); ?></a> …
                            </td>
                            <td></td>
                            <td></td>
                            <td>
                                <a class="link-update" href="<?php echo U('Admin/meet/edit');?>/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" href="<?php echo U('Admin/meet/destory');?>/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
